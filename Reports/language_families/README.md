...
Get counts of families and area coverage for TeDDi. This is easy because
we have already combined the TeDDi data with Glottolog.
...
the case of TeDDi, there are 9 language isolates in the current sample,
so we add 8.
